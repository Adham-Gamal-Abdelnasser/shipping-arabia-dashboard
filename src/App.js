...
import Message from './pages/Message.jsx'; // Added import
  ...
  return (
    <>
      ...
      <div className='App'>
        <BrowserRouter>
          <Routes>
            <Route index={true} element={<Register></Register>}></Route>
            ...
            <Route path='/' element={<Layout></Layout>}>
              ...
              <Route path='message' element={<Message></Message>}></Route> // Added route
            </Route>
